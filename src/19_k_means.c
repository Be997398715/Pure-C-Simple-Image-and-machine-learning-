...
//cluster function
static void cluster(Point* point, Point* mean, int* center, float** distance, int N, int k, int verbose)
{
    for (int i = 0; i < N; i++)
    {
        for (int j = 0; j < k; j++)
...
static float gete(Point* point, Point* mean, int* center, int N, int k)
{
    float cnt=0, sum=0;
    for (int i = 0; i < N; i++)
    {
...
static void getmean(Point* point, Point* mean, int* center, int verbose, int N, int k)
{
    Point sum;
    int count;
    for (int i = 0; i < k; i++)
